    ...
    const states = {
        ...
        ERROR: (
            <>
                ...
                <button
                    onClick={closeModal}
                    className="mx-auto mt-8 px-7 py-2 text-sm font-medium text-white shadow bg-gray-500 focus:outline-none focus:ring rounded hover:bg-gray-600 hover:shadow-none"
                >
                    Cancel
                </button>
            </>
        ...
        SUCCESS: (
            <>
                ...
                <button
                    onClick={closeModal}
                    className="mx-auto mt-8 px-7 py-2 text-sm font-medium text-white shadow bg-light-blue-500 focus:outline-none focus:ring rounded hover:bg-light-blue-600 hover:shadow-none"
                >
                    OK
                </button>
            </>
